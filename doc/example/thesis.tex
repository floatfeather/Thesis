...
\pkuthssinfo{
	...
	ctitle = {基于谓词预测的结合现有技术的缺陷定位工具的设计与实现}, 
	etitle = {The Design and Implementation of a Fault Localization Tool that Combines
	Existing Techniques Based on Predicate Prediction},
	cauthor = {王然},
	eauthor = {Ran Wang},
